...
public:
	...
	HEdge* getmStart() const;
	HEdge* getmNext() const;
...
public:
	...
	double getmAera() const;
	Eigen::Vector3f getmNormal() const;

	double computeFaceAera();
...
public:
	...
	void generateUniformLforSmooth(Eigen::SparseMatrix<float>* L, std::vector<Vertex*>& vertexList);
	void generateCotangtLforSmooth(Eigen::SparseMatrix<float>* L, std::vector<Vertex*>& vertexList);
	/************************************************************************/
